...
|---|---|---|---|
| Live Agent Category | • Maximum of two (2) Google Cloud Next 2026 conference tickets (April 22-24, 2026) (Value: $2,299 each) • $10,000 in USD • $1,000 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account) • Virtual Coffee with a Google Team Member • Social Promo | 1 | All eligible submissions that enter in the Live Agents category and uses Gemini Live API or the use of ADK. The agents are hosted on Google Cloud. |
| Creative Storyteller Category | • Maximum of two (2) Google Cloud Next 2026 conference tickets (April 22-24, 2026) (Value: $2,299 each) • $10,000 in USD • $1,000 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account) • Virtual Coffee with a Google Team Member • Social Promo | 1 | All eligible submissions that enter in the Creative Storyteller category and use Gemini's interleaved/mixed output capabilities. The agents are hosted on Google Cloud. |
| UI Navigator Category | • Maximum of two (2) Google Cloud Next 2026 conference tickets (April 22-24, 2026) (Value: $2,299 each) • $10,000 in USD • $1,000 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account) • Virtual Coffee with a Google Team Member • Social Promo | 1 | All eligible submissions that are in the UI Navigator category and uses Gemini multimodal to interpret screenshots/screen recordings and output executable actions. The agents are hosted on Google Cloud. |
...
| Winner | Prize | Quantity | Eligible |
|---|---|---|---|
| Grand Prize | • $25,000 in USD • $3,000 in Google Cloud Credits for use with a [Cloud Billing Account](https://docs.cloud.google.com/billing/docs/how-to/manage-billing-account) • Virtual Coffee with a Google Team Member • Social Promo • Maximum of two (2) Google Cloud Next 2026 conference tickets (April 22-24, 2026) (Value: $2,299 each) • Maximum of two (2) travel stipends for airfare and hotel to Google Cloud Next 2026 in Las Vegas, NV (maximum of $3,000 USD each)*A • Opportunity to demo your Project in a Google Cloud Next 26 presentation (additional requirements below).**B | 1 | All eligible submissions. |
...
Odds of winning any prize depends on the number of eligible entries received during the Contest Period and the skill of the entrants. No transfer, substitution or cash equivalent for prize(s) is allowed, except at Sponsor's sole discretion.
...
Contest Entities are not responsible for any malfunction of the entire Contest Site or any late, lost, damaged, misdirected, incomplete, illegible, undeliverable, or destroyed Submissions or entry materials due to system errors or technical failures.

##### 18. RIGHT TO CANCEL, MODIFY OR DISQUALIFY:

If for any reason the Contest is not capable of running as planned, Google reserves the right at its sole discretion to cancel, terminate, modify or suspend the Contest.

##### 19. NOT AN OFFER OR CONTRACT OF EMPLOYMENT:

Under no circumstances shall the submission of a Submission into the Contest, the awarding of a prize, or anything in these Rules be construed as an offer or contract of employment with either Google, or the Contest Entities. You acknowledge that you have submitted your Submission voluntarily and not in confidence or in trust. You acknowledge that no confidential, fiduciary, agency or other relationship or implied-in-fact contract now exists between you and Google or any of the Contest Entities.
